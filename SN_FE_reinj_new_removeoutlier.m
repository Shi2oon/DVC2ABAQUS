...
dvcdatapth = 'R:\bone\thr91a selim code\bone preload vs load_DVC_Vec_64x64x64_50_ov_preloadvsload-postprocess-25pixels-0.8correlation for report 17012017\RBM corrected/text-All.txt';
fe_pth = 'R:\bone\thr91a selim code/node.xlsx';
modelinp = 'R:\bone\thr91a selim code/Job-1.inp';
outputname = 'R:\bone\thr91a selim code\bone preload vs load_DVC_Vec_64x64x64_50_ov_preloadvsload-postprocess-25pixels-0.8correlation for report 17012017\RBM corrected/PatchedInp.inp';



% Registration
OriPts = [0.339261 0.955931 0;0.582259 0.377973 3.933552;0.713457 3.427302 3.933552]; %FE
DefPts=[0.2266068 -2.524738 0;0. -19.7263 7;14.3306 -18.5334 7]; %DVC
...
dvcdata(dvcdata(:,4)<-0.0125 | dvcdata(:,5)<-0.0187 | dvcdata(:,6)<-0.022,:)=[];
